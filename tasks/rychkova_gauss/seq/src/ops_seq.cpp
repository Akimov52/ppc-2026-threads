...
RychkovaGaussSEQ::RychkovaGaussSEQ(const InType &in) {
...
bool RychkovaGaussSEQ::PreProcessingImpl() {
  return true;
}

bool RychkovaGaussSEQ::RunImpl() {
...
bool RychkovaGaussSEQ::PostProcessingImpl() {
  return true;
}
