...
class BaranovAMultMatrixFoxAlgorithmOMP : public baranov_a_mult_matrix_fox_algorithm::BaseTask {
 public:
  static constexpr ppc::task::TypeOfTask GetStaticTypeOfTask() {
    return ppc::task::TypeOfTask::kOMP;
  }
  explicit BaranovAMultMatrixFoxAlgorithmOMP(const baranov_a_mult_matrix_fox_algorithm::InType &in);
